...
const FuncionarioDetail = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await axios.put(`http://localhost:8000/api/funcionarios/${id}/`, formData, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow rounded-2xl mt-8">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {/* RESCISÃO */}
        <h3 className="col-span-full text-xl font-semibold mt-6 mb-4">RESCISÃO</h3>
        <div className="flex flex-col">
